...
function switchPercentage_r5() {
  ...
  asset_total.map(function (val) {
    return val.splice(17, 7);
  });
  ...
  $(`${"#" + r5_id} #total-table-part`)
    .find("tbody")
    .html(tbodyHtml);
  initDataTable(`${"#" + r5_id} #total-table-part`, 380, 2);
...
function switchKey1_r5() {
  ...
  $(`${"#" + r5_id} #total-table-part`)
    .find("tbody")
    .html(tbodyHtml);
  initDataTable(`${"#" + r5_id} #total-table-part`, 380, 1);
}
...
function switchPercentage_r6() {
  ...
  $(`${"#" + r6_id} #total-table-part`)
    .find("tbody")
    .html(tbodyHtml);
  initDataTable(`${"#" + r6_id} #total-table-part`, 380, 2);
...
function switchKey1_r6() {
  ...
  $(`${"#" + r6_id} #total-table-part`)
    .find("tbody")
    .html(tbodyHtml);
  initDataTable(`${"#" + r6_id} #total-table-part`, 380, 1);
}
