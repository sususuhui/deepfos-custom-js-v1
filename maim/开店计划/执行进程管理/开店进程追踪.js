    ...
    <div class="card">
      <div class="card-body pb-1">
        <div class="d-flex align-items-center justify-content-left mb-2">
          ...
          <div>
            <div class="font-weight-semibold" style="font-size: medium;white-space: nowrap;">开店计划总数</div>
    ...
    <div class="card">
      <div class="card-body pb-1">
        <div class="d-flex align-items-center justify-content-left mb-2">
          ...
          <div>
            <div class="font-weight-semibold" style="font-size: medium;white-space: nowrap;">开店进程中</div>
    ...
    <div class="card">
      <div class="card-body pb-1">
        <div class="d-flex align-items-center justify-content-left mb-2">
          ...
          <div>
            <div class="font-weight-semibold" style="font-size: medium;white-space: nowrap;">已开店</div>
            <div class="font-weight-semibold" style="font-size: large">7</div>
          </div>
        </div>
      </div>
    ...
    <div class="card">
      <div class="card-body pb-1">
        <div class="d-flex align-items-center justify-content-left mb-2">
          ...
          <div>
            <div class="font-weight-semibold" style="font-size: medium;white-space: nowrap;">已停止</div>
            <div class="font-weight-semibold" style="font-size: large">7</div>
          </div>
        </div>
      </div>
