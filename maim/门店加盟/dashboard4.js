...
const r1 = () => {
  ...
  let html = `
    <div class="row">
        <div class="col-xl-12">
          <div class="card" id="card1" style="height: 370px; margin-left: 2px; margin-right:5px">
            <div class="card-header bg-white header-elements-inline listHeader" style="padding: 0.625rem 1.25rem">
              <h6 class="card-title text-nowrap mr-3 element-name hiddenStyle">干预前后分析-收入</h6>
            </div>
          </div>
        </div>
    </div>
    ...
    series: [
      {
        name: "",
        data: [
          9500 * (Math.random() * 0.05 + 1),
          9000 * (Math.random() * 0.1 + 1),
          8500 * (Math.random() * 0.1 + 1),
          8000 * (Math.random() * 0.1 + 1),
          7500 * (Math.random() * 0.1 + 1),
          7000 * (Math.random() * 0.1 + 1),
          6500 * (Math.random() * 0.1 + 1),
          6000 * (Math.random() * 0.1 + 1),
          5500 * (Math.random() * 0.1 + 1),
          5000 * (Math.random() * 0.1 + 1),
          4500 * (Math.random() * 0.1 + 1),
          3500 * (Math.random() * 0.1 + 1),
          3000 * (Math.random() * 0.05 + 1),
          3500 * (Math.random() * 0.1 + 1),
          4000 * (Math.random() * 0.1 + 1),
          4500 * (Math.random() * 0.1 + 1),
          5200 * (Math.random() * 0.1 + 1),
          6000 * (Math.random() * 0.1 + 1),
          6900 * (Math.random() * 0.1 + 1),
          7800 * (Math.random() * 0.1 + 1),
          8700 * (Math.random() * 0.1 + 1),
          9600 * (Math.random() * 0.1 + 1),
          10500 * (Math.random() * 0.1 + 1),
          11400 * (Math.random() * 0.1 + 1),
          12100 * (Math.random() * 0.1 + 1),
        ],
        type: "line",
      },
      {
