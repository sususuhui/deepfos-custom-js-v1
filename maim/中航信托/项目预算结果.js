...
const r1 = () => {
  ...
  let data = [
    ...
    ['2.3.3', '财务费用', '-', ' 1,417 ', ' 1,417 ', ' 1,417 ', ' 1,417 ', ' 17,655 ', '-', '-', '-', '-', ' -   '],
...
const r2c1 = () => {
  ...
  let data = [
    ...
    ['1.0', '销售收入', ' 420,332.75 ', ' 378,678.15 ', ' 41,654.60 '],
    ['2.0', '土地成本', ' 201,402.58 ', ' 181,443.77 ', ' 19,958.81 '],
    ['2.1', '开发成本', ' 114,412.82 ', ' 107,936.62 ', ' 6,476.20 '],
    ['3.0', '期间费用', ' 29,003.98 ', ' 26,488.55 ', ' 2,515.44 '],
    ...
    ['4.2', '土地增值税', ' 8,406.66 ', '-', '-'],
    ['5.0', '销售利润', ' 54,402.56 ', ' 62,809.22 ', '-'],
    ['6.0', '营业外收入', '-', '-', '-'],
    ['7.0', '营业利润合计', '-', '-', '-'],
    ['8.0', '企业所得税', ' 13,600.64 ', '-', '-'],
    ['9.0', '营业净利润', ' 40,801.92 ', '-', '-'],
    ['9.1', '营业净利率', '9.71%', '-', '-'],
    ['10.0', '营业毛利润', ' 104,517.35 ', '-', '-'],
    ['10.1', '营业毛利率', '24.87%', '-', '-'],
  ];
