...
function renderTable2(data, params) {
  ...
  var html = `<table class="table table-hover datatable-highlight dataTable no-footer table-striped" >
                <tr>
                    ...
                    <th style="text-align: center;">组合1</th>
                    <th style="text-align: center;">组合2</th>
                    <th style="text-align: center;">合理区间</th>
                    <th style="text-align: center;">组合1超标率</th>
                    <th style="text-align: center;">组合2超标率</th>
                </tr>
                <tr>
...
function ROI() {
  ...
  $(echartDom).css("background-color", "#82BC01");
...
<div class="d-flex">
  <div>
    <span class="font-size-sm opacity-75 mr-2">2021 目标</span>
  ...
  chart = cfs.echarts.init(miniEchartDom, Cus_theme, option);
  chart.clear();
  chart.setOption(option);

  chart.off("click");
  chart.on("click", (miniEchartDom) => {
    window.location.href = "http://main.seepln.com/v1_5_6/dashboard/showDashBoardLeft.html?param1=BIDE84GCAUD2FT&appid=70";
  });
...
function ROE() {
  ...
  $(echartDom).css("background-color", "#0F953A");
...
function IRR() {
  ...
  $(echartDom).css("background-color", "#FBC000");
