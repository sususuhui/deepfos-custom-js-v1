...
function Chart_R1C1(data, params) {
  ...
  pythonData_R1C1 = JSON.parse(data);
    ...
    series: [
      {
        ...
        data: [{ value: dataTargetRate * 100, name: "当月指标达成进度" }],
      },
      {
        name: "Gauge_Forecast",
        center: ["75%", "60%"],
        ...
        data: [{ value: dataForecastRate * 100, name: "当月预测达成进度" }],
      },
    ],
  };
  initEchart(componentId, option);
