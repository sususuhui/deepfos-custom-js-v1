const r1 = (params) => {
  ...
  <form id="r1c1-form">
    <div class="form-group row">
      <div class="col-3">
        <label class="col-form-label">门店编码</label>
        <input type="text" class="form-control" readonly name="StoreCode" value="" />
      </div>
      <div class="col-3">
        <label class="col-form-label">门店名称</label>
        <input type="text" class="form-control" readonly name="StoreNameCN" value="" />
      </div>
      <div class="col-3">
        <label class="col-form-label">大区</label>
        <input type="text" class="form-control" readonly name="TerritoryName" value="" />
      </div>
      <div class="col-3">
        <label class="col-form-label">省区</label>
        <input type="text" class="form-control" readonly name="AreaName" value="" />
      </div>
    </div>
    <div class="form-group row">
      <div class="col-3">
        <label class="col-form-label">片区</label>
        <input type="text" class="form-control" readonly name="DistrictName" value="" />
      </div>
      <div class="col-3">
        <label class="col-form-label">门店经理</label>
        <input type="text" class="form-control" readonly name="StoreMgrCn" value="" />
      </div>
      <div class="col-3">
        <label class="col-form-label">开店时间</label>
        <input type="text" class="form-control" readonly name="OpenDate" value="" />
      </div>
      <div class="col-3">
        <label class="col-form-label">城市</label>
        <input type="text" class="form-control" readonly name="CityCN" value="" />
      </div>
    </div>
    <div class="form-group row">
      <div class="col-3">
        <label class="col-form-label">省</label>
        <input type="text" class="form-control" readonly name="Province" value="" />
      </div>
      <div class="col-3">
        <label class="col-form-label">门店类型</label>
        <input type="text" class="form-control" readonly name="StoreType1" value="" />
      </div>
      <div class="col-3">
        <label class="col-form-label">城市级别</label>
        <input type="text" class="form-control" readonly name="CityTier" value="" />
      </div>
      <div class="col-3">
        <label class="col-form-label">外卖店</label>
        <input type="text" class="form-control" readonly name="DeliveryType" value="" />
      </div>
    </div>
    <div class="form-group row">
      <div class="col-3">
        <label class="col-form-label">商圈类型</label>
        <input type="text" class="form-control" readonly name="TAType" value="" />
      </div>
      <div class="col-3">
        <label class="col-form-label">门店状态</label>
        <input type="text" class="form-control" readonly name="Status" value="" />
      </div>
    </div>
  </form>
`;
...
const r3 = (params) => {
  console.log(params);
  console.log(showDashBoard.globalCurrentPovObj);
  debugger;
};
